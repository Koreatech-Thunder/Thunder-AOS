package com.koreatech.thunder.data

import io.kotest.core.spec.style.BehaviorSpec

class ThunderScenario : BehaviorSpec({
    ...
    given("사용자가 번개 참여하기 버튼을") {
        `when`("번개 제한 인원이") {
            and("가득찬 상태에서 참여하기 버튼을 누르면") {
                and("번개 인원이 모두 모여 참여할 수 없습니다. 다이얼로그를 띄운 후에 `대기하겠습니다.` 버튼을 누르면") {
                    then("`대기를 등록했습니다. 알림이 갈 것입니다.` 메시지와 함께 대기열을 보여준다.") {
                    }
                }
            }
